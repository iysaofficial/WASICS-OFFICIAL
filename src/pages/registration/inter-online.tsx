...
function InternationalOnline() {
  ...
  const scriptURL = "https://script.google.com/macros/s/AKfycbxV_Ul-PdOgXJdMeEo9rnOgiQXTcwUDZDhNw4sd34TRMsTyWVnS9N8skPLEVO1g264/exec";
...
export default InternationalOnline;
